...
export async function startRoomCompositeEgress({ roomName: _roomName, outputUrl: _outputUrl }: StartEgressParams): Promise<{ egressId: string }> {
...
export async function stopEgress({ egressId: _egressId }: StopEgressParams): Promise<{ status: 'stopped' }> {
