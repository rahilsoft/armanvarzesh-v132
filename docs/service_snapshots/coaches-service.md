# SERVICE_SNAPSHOT — coaches-service

**Path:** `services/coaches-service`
...
## Dependencies
- Packages: @nestjs/common, @nestjs/core, @nestjs/graphql, @nestjs/platform-express, @prisma/client, class-validator, class-transformer, graphql, reflect-metadata, rxjs, @nestjs/terminus, joi, @nestjs/throttler, @opentelemetry/api, @opentelemetry/sdk-node, @opentelemetry/exporter-trace-otlp-http, @opentelemetry/auto-instrumentations-node, dataloader, @nestjs/apollo, @arman/service-kit ...
