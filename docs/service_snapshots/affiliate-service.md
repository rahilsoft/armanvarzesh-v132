# SERVICE_SNAPSHOT — affiliate-service

**Path:** `services/affiliate-service`
...
## Dependencies
- Packages: @nestjs/common, @nestjs/core, @nestjs/graphql, graphql, reflect-metadata, rxjs, @nestjs/terminus, joi, @nestjs/throttler, @opentelemetry/api, @opentelemetry/sdk-node, @opentelemetry/exporter-trace-otlp-http, @opentelemetry/auto-instrumentations-node, dataloader, @prisma/client, @nestjs/platform-express, @nestjs/apollo, @apollo/server, @arman/service-kit, @arman/integration ...
