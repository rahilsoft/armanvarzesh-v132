# SERVICE_SNAPSHOT — users-service
...
## Dependencies
- Packages: @nestjs/common, @nestjs/core, @nestjs/graphql, @nestjs/jwt, @nestjs/platform-express, @prisma/client, graphql, reflect-metadata, rxjs, class-validator, class-transformer, @nestjs/terminus, joi, @nestjs/throttler, @opentelemetry/api, @opentelemetry/sdk-node, @opentelemetry/exporter-trace-otlp-http, @opentelemetry/auto-instrumentations-node, dataloader, @nestjs/apollo ...
