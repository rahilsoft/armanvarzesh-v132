...
/**
 * Root module for the nutrition microservice. Exposes GraphQL API
 * composed of the nutrition module and provides the Prisma service.
 */
@Module({
  controllers: [HealthController, MetricsController],
  imports: [WearablesModule, HabitsModule, HydrationModule, 
    ...
    NutritionModule, EnvValidationModule],
  providers: [
