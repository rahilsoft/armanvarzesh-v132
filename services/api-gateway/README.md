...
## Overview
Short description of `api-gateway`. Explain purpose, boundaries, and main responsibilities.
...
### Physio Subgraph
- Add Router/Gateway route to `http://physio-subgraph:4016/graphql`
- Health: `http://physio-subgraph:4016/health`
